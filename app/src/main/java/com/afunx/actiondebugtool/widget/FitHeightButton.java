...
/**
 * it will make text most large to fit Button height
 * <p>
 * refer to:
...
public class FitHeightButton extends AppCompatButton {

    private static final String TAG = "FitHeightButton";
    private static final boolean DEBUG = false;
    private Paint mTextPaint;
    private final float minTextSizePx = 8;
    private final float maxTextSizePx = 1024;

    public FitHeightButton(Context context, @Nullable AttributeSet attrs) {
        super(context, attrs);
        // set gravity center
